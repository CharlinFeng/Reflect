...
2.It’s better to use implicitly optional type for properties. Try not to use strange type like var v1: [string?]? and this frame has lots of assertion to help you use data type reasonably.<br/>
